<img width="756" height="482" alt="image" src="https://github.com/user-attachments/assets/f7c3c708-6ba6-4778-945a-f7be56494abb" />## 1. **Отличие решаемых задач в теории вероятностей и математической статистики. Основная задача статистики. Вероятность. ЗБЧ. Описание случайных величин: дискретных и непрерывных. Характеристики распределений. Квантиль.**
...
- **Гомогенность дисперсий:** Дисперсии внутри каждой из групп должны быть приблизительно равны. Это условие можно проверить с помощью тестов на равенство дисперсий, например, теста Левена или теста Бартлетта.
