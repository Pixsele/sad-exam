...
2. **Гомоскедастичность**  
   ...
   - Проверяется графиком остатков от $\hat{y}$ или $x$.

3. **Автокорреляция**  
   Особенно важно для временных рядов.  
   - Критерий Дарбина–Уотсона.
  
   $$DW = \frac{\sum_{t=2}^n (e_t - e_{t-1})^2}{\sum_{t=1}^n e_t^2}$$

   При значении = 2 - автокорреляции нет

4. **Отсутсвие мультиколлинеарности**
   Мультиколлинеарность — это наличие сильной линейной зависимости между независимыми переменными регрессии.
