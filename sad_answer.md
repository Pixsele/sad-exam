...
Метод наименьших квадратов (МНК) — это способ нахождения коэффициентов $\beta_0$ и $\beta_1$, при котором сумма квадратов остатков будет минимальной:$$\sum (y_i - \hat{y}_i)^2 \rightarrow \min$$
